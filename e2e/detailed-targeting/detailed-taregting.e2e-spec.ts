import { DetailedTargetingPage as page } from './detailed-targeting.po';
...
describe('aitarget-components Detailed Targeting', function () {
  ...
  describe(`selected`, () => {
    it('should have preselected groups of detailed targeting', () => {
      expect(page.getDetailedTargetingSelectedGroups()
                 .count())
        .toBe(4);
    });

    it('should have preselected items of detailed targeting', () => {
      expect(page.getDetailedTargetingSelectedItems()
                 .count())
        .toBe(8);
    });
